...
blue_task = Task(
    description=(
        ...
        "                 - KEIN nmap aggressive=True für Top-1000 — das dauert >4 Minuten ohne Mehrwert\n\n"
...
findings_task = Task(
    description=(
        ...
        "2. Bekannte CVEs NUR für tatsächlich gefundene Services — via searchsploit und DuckDuckGo\n\n"
        "SEARCHSPLOIT-REGEL: Querue searchsploit IMMER mit '<service> <version>' — "
        "nie nur mit dem Service-Namen allein. Beispiel: 'nginx 1.22' nicht 'nginx'. "
        "Wenn die Version unbekannt ist: kein searchsploit-Aufruf für diesen Service.\n"
        "RELEVANZ-PRÜFUNG: Wenn searchsploit Ergebnisse zurückgibt, prüfe ob der Titel "
        "exakt zum gefundenen Produkt passt. 'Ingress-NGINX' ≠ 'nginx'. "
        "'OpenSSH 7.x' ≠ 'OpenSSH 9.x'. Nur eintragen wenn Produktname UND Versionsnummer passen.\n"
